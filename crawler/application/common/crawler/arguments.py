...
def create_arguments(name=sys.argv[0], args=sys.argv[1:]):
    ...
    parser.add_argument("--redis_host", required=False, help="Redis server", default="localhost")
    ...
    parser.add_argument("--redis_password", required=False, help="Redis authentication password", default='')
    ...
    parser.add_argument("--crawl_type", required=False, help="Limit web pages", default='bds')
    ...
    if name == os.path.join(os.getcwd(), 'extractor.py'):
        ...
        # data warehouse
        parser.add_argument("--pg_host", required=False, default="localhost")
        parser.add_argument("--pg_port", required=False, default=5432)
        parser.add_argument("--pg_user", required=True, default="hoang")
        parser.add_argument("--pg_password", required=True, default="4983")
        parser.add_argument("--pg_db", required=False, default='test_crawler')
